...
export default function Signup() {
    ...
    const componentDidMount = () => {
        ...
        axios.post('http://localhost:3000/users/all', user).then(response => this.setState({ email: user.email }));
    }
    ...
    return (
        ...
        <Container>
                ...
                <h1 className="text-center mt-2 p-5">Signup</h1>
                    ...
                    <Button className="w-100 text-center mt-4" type="submit" href="/login" onClick={ ()=> handleSubmit() } >Signup</Button>
                </Form>
                </div>
                </Col>
                </Row>
