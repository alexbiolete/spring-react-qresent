          ...
          <div className="flex-1 inline-flex items-center justify-begin">
            ...
            <div className="flex-1 inline-flex items-center justify-end">
              ...
              <div className="relative">
                <button
                  className="flex items-center space-x-1 focus:outline-none pl-2 pr-3 py-1 rounded-full border-2 border-transparent md:hover:border-gray-200 text-gray-600 md:hover:text-gray-700 md:transition ease-in-out duration-500"
                ...
                >
                  ...
                  <span className="hidden md:block font-medium tracking-wider text-sm">
